  ...
  "inline-flex cursor-pointer items-center justify-center transition-colors focus-visible:outline-none disabled:cursor-wait disabled:opacity-60",
  {
    variants: {
      variant: {
        ...
        icon:
          "h-10 w-10 rounded-full border border-neutral-200 bg-white p-0 text-neutral-600 shadow-[0_1px_3px_0_rgb(0_0_0/0.08)] hover:bg-neutral-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-50 focus-visible:ring-black/60 dark:border-neutral-700/70 dark:bg-neutral-800/80 dark:backdrop-blur-sm dark:text-neutral-400 dark:shadow-[inset_0_1px_0_rgb(255_255_255/0.07),0_2px_8px_0_rgb(0_0_0/0.5)] dark:hover:bg-neutral-700/80 dark:focus-visible:ring-offset-neutral-950 dark:focus-visible:ring-white/60",
        subtle:
