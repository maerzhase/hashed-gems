...
export const RARITY_BADGE: Record<Rarity, string> = {
  ...
  rare: "border-transparent bg-blue-100 text-blue-700 dark:border-blue-500/25 dark:bg-blue-950/70 dark:text-blue-300",
  epic: "border-transparent bg-purple-100 text-purple-700 dark:border-violet-500/30 dark:bg-violet-950/70 dark:text-violet-300",
  legendary:
